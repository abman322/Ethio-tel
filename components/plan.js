...
function Plan() {
  ...
  return (
    <div className=" flex flex-col justify-center items-center bg-hero-banner bg-no-repeat bg-center bg-cover text-white h-[500px]">
      <div>
        <h1 className=" text-xl font-bold m-4 text-black">
          Find the best fiber plan for you
        </h1>
      </div>
      <div className=" flex ">
        <div className=" bg-white p-6 w-96 text-black rounded-2xl h-96 flex flex-col items-center text-center">
          ...
          <div>
            <h2 className=" text-xl p-1 font-bold">
          ...
          <div className=" flex flex-col mt-5">
            <button
              className=" bg-slate-300 rounded-2xl px-16 py-2 hover:bg-black text-white m-1"
              id="low"
              onClick={handleClick}
            >
              1-5
        ...
        <div
          className=" ml-4  hidden bg-white p-6 w-96 text-black rounded-2xl h-96 flex-col items-center text-center"
          id="plan"
        >
          ...
          <div className=" flex flex-col mt-5">
            <button
              className=" bg-slate-300 rounded-2xl px-12 py-2 hover:bg-black text-white m-1"
              id="gen"
        ...
        <div
          className=" ml-4 hidden  bg-white p-6 w-96 text-black rounded-2xl h-96 flex-col justify-center items-center text-center"
          id="recom"
        >
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className=" mb-4 text-red-300 w-14 h-14"
          >
            <path
              strokeLinecap="round"
          ...
          <div>
            <h2 className=" text-xl p-1 font-bold">You will need</h2>
            <p className=" text-4xl font-bold pt-4">10 Mbps</p>
            <p className="">1359.20 birr/month</p>
          </div>
          <div className=" flex flex-col mt-5">
            <button className=" hover:bg-slate-300 rounded-2xl px-12 py-2 bg-black text-white m-1">
              Get Started
            </button>
          </div>
        </div>
